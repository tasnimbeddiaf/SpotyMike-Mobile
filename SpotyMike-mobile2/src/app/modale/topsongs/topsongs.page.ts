...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonRow, IonGrid, IonCol, IonIcon, ModalController, IonList, IonListHeader, IonItem, IonLabel,IonThumbnail, IonAvatar } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [IonAvatar, IonLabel, IonItem, IonListHeader, IonList, IonIcon, IonCol, IonGrid, IonRow, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonThumbnail, ListgridPage]
})
